...
%%here
%%
As can be seen in the list above some of the parameters have strong relations to eachother. These relations will now be explained. The Tabu rule and the aspiration criteria values 
