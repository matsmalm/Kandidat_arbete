...
But the computational time will even grater be effekted if one wants to increase the probability the finding of a solution atall. Mening if The Max_allowed_steps value is increest, the chanses of finding a complet solution chould incresses.\\
