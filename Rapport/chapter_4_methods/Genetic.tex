...
\end{itemize}
%% Crossover
For Crossover there are also different methods, such as n-point shuffle crossover, uniform crossover and variable crossover.
\begin{itemize}
...
%
In comparison \eqref{fitness2} gives a more fit individual a higher fitness value than \eqref{fitness3}, but using \eqref{fitness3} was not considered to be a limitation, as a high selection pressure can lead to premature convergence \cite{GAHandbook1}.\\\\ % Check if correct reference.
%% Selection
