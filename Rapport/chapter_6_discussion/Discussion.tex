...
%ordning:
%discussion/analys av kördata
	%styrkor och svagheter hos de implementerade
		%varför dessa egenskaper?
		%hur ser vi dessa egenskaper ur mätdata?
...
%utvärdera fördelar och nackdelar som simuleringsmiljön besiter.
