...
\\For the Manhattan\footnote{A special symmetric environment, see \cite{paper1}} grid the simulation conditions were different. \\
%fyll ut med hur!!!
...
\begin{itemize}
\item{For enviroments of size 15x15 and larger the amount RAM memory used was significant.}
